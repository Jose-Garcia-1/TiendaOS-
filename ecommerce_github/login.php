<?php
/* Vista de inicio de sesión de TiendaOS.
   Verifica si el usuario ya tiene una sesión activa; si es así, lo redirige directamente al catálogo. */
session_start();
...
/* --- Estilos del enlace para redirigir al registro --- */
...
<div class="card">
    ...
    <!-- Formulario de inicio de sesión que envía los datos al controlador -->
    ...
    <!-- Enlace para redirigir a la página de registro de nuevos usuarios -->
    <div class="link">
