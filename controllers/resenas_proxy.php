...
if ($accion === 'puede_resenar') {
    ...
    /* 4. Comunicación con el contenedor Docker de reseñas (servicio externo) para obtener los datos. */
    $producto_id = intval($_GET['producto_id'] ?? 0);
    $json = @file_get_contents("http://localhost:3000/resenas/{$producto_id}");
    echo $json ?: '[]';
    ...
    /* 5. Envío de la nueva reseña al servicio de reseñas a través de cURL. */
    $ch = curl_init("http://localhost:3000/resenas");
